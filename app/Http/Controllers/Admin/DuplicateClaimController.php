    ...
    public function approve($id, Request $request)
    {
        ...
        try {
            ...
            $resident = Resident::create([
                ...
                'middle_name' => ! empty($data['middle_name']) ? strtoupper($data['middle_name']) : null,
                'suffix' => ! empty($data['suffix']) ? strtoupper($data['suffix']) : null,
                'birthdate' => $birthdate,
                'age' => $age,
                'gender' => $data['gender'],
                'civil_status' => $data['civil_status'] ?? null,
                'nationality' => ! empty($data['nationality']) ? strtoupper($data['nationality']) : 'FILIPINO',
                'occupation' => ! empty($data['occupation']) ? strtoupper($data['occupation']) : null,
                'religion' => ! empty($data['religion']) ? strtoupper($data['religion']) : null,
                'place_of_birth' => ! empty($data['place_of_birth']) ? strtoupper($data['place_of_birth']) : null,
                'person_status' => $personStatus,
                'building_no' => ! empty($data['building_no']) ? strtoupper($data['building_no']) : null,
                'unit_no' => ! empty($data['unit_no']) ? strtoupper($data['unit_no']) : null,
                'street' => ! empty($data['street']) ? strtoupper($data['street']) : 'MOLINO I',
                'subdivision' => ! empty($data['subdivision']) ? strtoupper($data['subdivision']) : null,
                'barangay' => ! empty($data['barangay']) ? strtoupper($data['barangay']) : 'MOLINO I',
                'purok' => ! empty($data['purok']) ? strtoupper($data['purok']) : null,
