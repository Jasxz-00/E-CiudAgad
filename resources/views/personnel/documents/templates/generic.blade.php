...
@section('body')
    ...
    <p style="margin-bottom:16px;text-indent:36px;">
        ...
        {{ $resident['civil_status'] }}, Filipino citizen, and a bona fide resident of
        <b>{{ $resident['address'] }}</b>, is a person of good moral character and is entitled
        to the issuance of this document per the official records of this barangay.
    </p>
